...
$("body").on("click","#btnCargar",function(e){
    ...
    if($("#xml").val()!=""){
      ...
      url:URL+"functions/facturaventa/leerxml.php", 
      ...
      cache:false
			...
			// console.log(xmlDoc);
$.get(msg.archivo,{},function(xml){ //Abrimos el archivo noticias.xml
		...
		console.log(xml);
	// alert(xml);
	// console.log(xml);cac:Attachment
...
$(".total").formatCurrency({decimalSymbol:',',digitGroupSymbol:'.'});
      ...
      url:URL+"functions/empresa/consultarempresaventa.php", 

      type:"POST", 

	  data: {"nitP":$("#nitReceptor").val(),"nit":$("#nitEmisor").val()}, 
