...
$aDescuento["valorDescuento"]=$oControl->eliminarMoneda($datos["valorDescuento"]); 
$aDescuento["numeroCuotas"]=$datos["cuotas"]; 
$aDescuento["valorCuota"]=$oControl->eliminarMoneda($datos["valorCuota"]); 
$aDescuento["estado"]=1;
...
for ($i=0; $i < $datos["cuotas"]; $i++) { 
    ...
    $aCuota["valorCuota"]=$oControl->eliminarMoneda($datos["valorCuota"]);
    $aCuota["estado"]=1;
