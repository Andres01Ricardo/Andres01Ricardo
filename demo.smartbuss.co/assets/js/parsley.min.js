...
! function(a) {
    ...
    a.listen = function(a, d) {
        ...
        if ("string" != typeof d || "function" != typeof e) throw new Error("Parámetros Incorrectos");
        a.on(c(d), b(e))
    }, a.unsubscribe = function(a, b) {
        if (r(), "string" != typeof a || "function" != typeof b) throw new Error("Argumentos Erróneos");
        ...
        minlength: "Este valor es demasiado corto. Se debe tener %s caracteres o más.",
        maxlength: "Este valor es demasiado largo. Se debe tener %s caracteres o menos.",
        length: "Esta longitud valor no es válido. Debe estar entre %s y %s caracteres de longitud.",
        mincheck: "Debe seleccionar al menos %s opciones.",
        maxcheck: "Debe seleccionar opciones %s o menos.",
