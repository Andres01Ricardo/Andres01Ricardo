...
$("body").on("click","#btnGuardar",function(e){
    e.preventDefault();
      if(true === $("#frmGuardar").parsley().validate()){
          Swal.fire({
          title: 'Está seguro?',
          text: 'Está a punto de agregar comision a '+$("[name='datos[idEmpleado]']").find("option:selected").html()+'!',
          icon: 'warning', 
          ...
          return new Promise(function(resolve) {
            ...
            $.ajax({
            url:URL+"functions/nomina/guardarcomision.php", 
            type:"POST", 
            data: data,
            contentType:false, 
            processData:false, 
