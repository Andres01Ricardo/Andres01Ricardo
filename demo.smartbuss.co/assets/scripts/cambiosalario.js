...
$("body").on("click","#btnGuardar",function(e){
    e.preventDefault();
      if(true === $("#frmGuardar").parsley().validate()){
        ...
        Swal.fire({
        title: 'Está seguro?',
        text: 'Está a punto de hacer un cambio de salario a '+$("[name='datos[idEmpleado]']").find("option:selected").html()+'!',
        icon: 'warning', 
        ...
        preConfirm: function(result) {
          return new Promise(function(resolve) {
            ...
            $.ajax({
            url:URL+"functions/nomina/guardarcambiosalario.php", 
            type:"POST", 
            data: data,
            contentType:false, 
            processData:false, 
            ...
            cache:false 
              ...
              if(msg.msg){
                Swal.fire(
                  {
                  icon: 'success',
                  title: 'Cambio de salario realizado!',
                  text: 'con exito',
                  closeOnConfirm: true,
                }
                ).then((result) => {
